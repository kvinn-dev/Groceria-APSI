                ...
                <CardContent className="grid p-0 md:grid-cols-2">
                    <form className="p-6 md:p-8" onSubmit={handleLogin}>
                        <FieldGroup>
                            ...
                            <Field className="text-gray-500 dark:text-muted-foreground">
                            ...
                            <Field className="text-gray-500 dark:text-muted-foreground">
                                <div className="flex items-center">
                                    ...
                                    <a
                                        ...
                                        className="ml-auto text-[13px] text-green-600 underline-offset-2 hover:font-semibold hover:underline"
                                    >
                    ...
                    <div className="relative hidden bg-muted md:block">
                        <img
                            ...
                            alt="Image"
                            className="absolute inset-0 h-140 w-130 object-cover"
                        />
                    </div>
                </CardContent>
            </Card>
