        ...
        <CardContent className="grid p-0 md:grid-cols-2">
          <form className="p-6 md:p-8" onSubmit={handleLogin}>
            <FieldGroup>
              ...
              <Field className="text-gray-500">
                <div className="flex items-center">
                  ...
                  <a
                    ...
                    className="ml-auto text-green-600 text-[13px] underline-offset-2 hover:font-semibold hover:underline"
                  >
              ...
              <FieldDescription className="text-center">
                ...
                <a
                  href="/register"
                  className="text-green-600 font-medium hover:!font-semibold hover:!text-green-600"
                >
                  Sign up
                </a>
              </FieldDescription>
          ...
          <div className="bg-muted relative hidden md:block">
            <img
              ...
              alt="Image"
              className="absolute inset-0 h-140 w-130 object-cover dark:brightness-[0.2] dark:grayscale"
            />
          </div>
        </CardContent>
      </Card>
