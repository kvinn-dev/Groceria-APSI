                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400">Create a new product in your store.</p>
                        </div>
                    </div>
                </div>
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-2 p-1 bg-gray-100 dark:bg-gray-900 rounded-lg text-sm">
                                        <button
                                            ...
                                            onClick={() => {
                                                setImageType('upload');
                                                setImagePreview(data.image ? URL.createObjectURL(data.image) : null);
                                            }}
